      ...
      <div className='flex items-center justify-center'>
            <div className='relative'>
                <motion.div initial={{opacity: 0, scale: 0}} animate={{opacity: 1, scale: 1}} transition={{type: "tween", duration: 0.2}}>
                    <Image src="https://media.licdn.com/dms/image/C4D03AQE8Vc3r22oL3g/profile-displayphoto-shrink_400_400/0/1647896549193?e=1722470400&v=beta&t=7hP_vrrfSi6oYrTU2XSqWUFpzvi4HqtapgfF_WuVlEI" alt= "Alex portrait" width={192} 
